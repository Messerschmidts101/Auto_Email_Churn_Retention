...
def main(
    ...
    print(f"[[ai_ml.model.pipeline]] 🪵 Showing X Train")
    print(X_train.head(10))
    print(f"[[ai_ml.model.pipeline]] 🪵 Showing y Train")
    print(y_train.head(10))
    print(f"[[ai_ml.model.pipeline]] 🪵 Showing X Test")
    print(X_test.head(10))
    print(f"[[ai_ml.model.pipeline]] 🪵 Showing y Test")
    ...
    print(f"[[ai_ml.model.pipeline]] 🪵 Print Results Y Actual")
    print(y_test.head(10))
    print(f"[[ai_ml.model.pipeline]] 🪵 Print Results Y Pred")
    print(y_pred[:10])
